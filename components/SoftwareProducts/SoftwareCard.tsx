...
export default function SoftwareCard({
  ...
  return (
    <Card className="mb-6 flex aspect-[3/4] h-auto w-[12em] md:w-[14em] max-w-sm flex-col items-center justify-center overflow-hidden rounded-xl bg-white shadow-lg hover:border-blue-600 hover:dark:border-emerald-500">
      ...
      <div className="relative w-full px-2 pl-5 py-4">
        ...
        <p className="m-0 text-sm line-clamp-2 w-full font-bold text-gray-900 dark:text-gray-50">
          {title}
        </p>
